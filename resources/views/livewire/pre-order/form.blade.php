                ...
                <form action="#" wire:submit.prevent="simpanDataPreOrder">
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            @if ($show_modal == 1 || $show_modal == true)
                                <div class="col-md-6 mb-5">
                                    <label for="" class="form-label">Quotation</label>
                                    <select name="id_quotation" class="form-select form-select-solid"
                                        wire:model="id_quotation" data-control="select2"
                            ...
                            @else
                                <div class="col-md-6 mb-5">
                                    ...
                                    <select name="id_customer" wire:model="id_customer"
                                        ...
                                        data-dropdown-parent="#modal_form" data-placeholder="Pilih" required>
                                        <option value="">Pilih</option>
                            ...
                            <div class="col-md-6 mb-5">
                                ...
                                <select name="id_tipe_pembayaran" class="form-select form-select-solid"
                                    wire:model="id_tipe_pembayaran" data-control="select2"
                                    data-dropdown-parent="#modal_form" data-placeholder="Pilih">
                                    <option value="">Pilih</option>
                            ...
                            <div class="col-md-6 mb-5">
                                ...
                                <select name="id_metode_pembayaran" class="form-select form-select-solid"
                                    wire:model="id_metode_pembayaran" data-control="select2"
                                    data-dropdown-parent="#modal_form" data-placeholder="Pilih">
                                    <option value="">Pilih</option>
