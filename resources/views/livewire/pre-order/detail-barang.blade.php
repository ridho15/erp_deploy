        ...
        <div class="col-md mb-5">
            <form action="#" method="POST" wire:submit.prevent="simpanBarang">
                ...
                <div class="mb-5" wire:ignore>
                    ...
                    <textarea name="keterangan" wire:model="keterangan" class="form-control form-control-solid" placeholder="Masukan keterangan"></textarea>
                    @error('keterangan')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
                <div class="d-flex justify-content-between mb-5">
                    ...
                    <button type="submit" class="btn btn-sm btn-outline btn-outline-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="Simpan Data">
...
@push('js')
    <script>
        ...
        Livewire.on('onClickHapusBarang', async(id) => {
            const response = await alertConfirm("Peringatan ?", "Apakah kamu yakin ingin menghapus barang dari orderan ?")
