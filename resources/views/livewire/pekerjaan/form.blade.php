<div>
    <div wire:ignore.self class="modal fade kondisi" tabindex="-1" id="modal_form">
            ...
            <div class="modal-content">
                ...
                <form action="#" wire:submit.prevent="simpanPekerjaan">
                    <div class="modal-body">
                        ...
                        <div class="mb-5">
                            <label for="" class="form-label required">Keterangan</label>
                            <input type="text" class="form-control form-control-solid" name="keterangan" wire:model="keterangan" placeholder="Masukkan keterangan" required>
                            @error('keterangan')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
