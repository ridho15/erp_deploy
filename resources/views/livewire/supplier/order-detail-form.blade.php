            ...
            <div class="modal-content">
                ...
                <form action="#" wire:submit.prevent="simpanDataOrderBarang">
                    <div class="modal-body">
                        ...
                        <div class="mb-5">
                            <label for="" class="form-label require">Quantity</label>
                            <input type="text" name="qty" wire:model="qty" class="form-control form-control-solid" placeholder="Masukkan Quantity" required>
                            @error('qty')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
