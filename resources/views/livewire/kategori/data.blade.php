                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <button class="btn btn-sm btn-icon btn-info" data-bs-toggle="tooltip"
                                                data-bs-placement="top" title="Tambah Barang Kategori"
                                                wire:click="$emit('onClickTambahBarang', {{ $item->id }})">
                                                <i class="bi bi-plus"></i>
                                            </button>
                                            <button class="btn btn-sm btn-icon btn-primary" data-bs-toggle="tooltip"
                                                data-bs-placement="top" title="Lihat Barang Kategori"
                                                wire:click="$emit('onClickLihatBarang', {{ $item->id }})">
