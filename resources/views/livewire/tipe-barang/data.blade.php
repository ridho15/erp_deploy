                    ...
                    @if (count($listTipeBarang) > 0)
                        @foreach ($listTipeBarang as $index => $item)
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <button class="btn btn-sm btn-icon btn-success" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit Tipe Barang" wire:click="$emit('onClickEdit', {{ $item->id }})">
                                            <i class="bi bi-pencil-square"></i>
                                        </button>
                                        <button class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Hapus Tipe Barang" wire:click="$emit('onClickHapus', {{ $item->id }})">
