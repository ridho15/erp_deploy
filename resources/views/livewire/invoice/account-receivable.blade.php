        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    @include('helper.alert-message')
                    <div class="text-center">
                        @include('helper.simple-loading', ['target' => 'tanggal,id_customer_filder,id_user_filter,status_pekerjaan', 'message' => 'Menyimpan data ...'])
                    </div>
                    <div class="mb-5">
                    ...
                    <div class="mb-5">
                        <label for="" class="form-label">Pembuat</label>
