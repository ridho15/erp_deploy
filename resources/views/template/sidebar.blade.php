        ...
        <div class="hover-scroll-overlay-y my-5 me-n4 pe-4" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu menu-column menu-sub-indention menu-active-bg menu-state-primary menu-title-gray-700 fs-6 menu-rounded w-100 fw-semibold"
                ...
                <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                    ...
                    <div class="menu-item">
                        <a class="menu-link @if(in_array('account-receivable', $active))  active @endif"
                            href="{{ route('pre-order.account-receivable') }}">
                            <span class="menu-icon">
                                <span class="svg-icon svg-icon-2">
                    ...
                    <div class="menu-item">
                        <a class="menu-link @if(in_array('done-pre-order', $active))  active @endif"
                            href="{{ route('pre-order.done') }}">
                            <span class="menu-icon">
                                <span class="svg-icon svg-icon-2">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="menu-item">
                        <a class="menu-link @if(in_array('pinjam-meminjam', $active))  active @endif"
                            href="{{ route('pinjam-meminjam') }}">
                            <span class="menu-icon">
                                <span class="svg-icon svg-icon-2">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span class="menu-title">Pinjam Meminjam</span>
                        </a>
                    </div>
                    <div class="menu-item">
