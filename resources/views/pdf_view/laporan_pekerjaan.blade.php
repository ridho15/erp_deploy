        ...
        <div style="float: left; width: 50%">
            <div>
                <table>
                    ...
                    <tr>
                        <td>Pelanggan</td>
                        <td>: <span class="fw-bold">{{ $laporanPekerjaan->projectUnit->project->customer->nama }}</span></td>
                    </tr>
                    <tr>
                        <td>Nama Project</td>
                        <td>: <span
        ...
        <table id="data">
            ...
            <tbody style="border: 1px solid black">
                @foreach ($listTemplatePekerjaan as $item)
                    <tr>
                        <td class="fw-bold text-capitalize">{{ \App\CPU\Helpers::numberToLetter($loop->iteration) }}
                        </td>
