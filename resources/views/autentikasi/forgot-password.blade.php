...
<head>
    <title>Forgot Password | {{ $web_config['web_name'] }}</title>
    <meta charset="utf-8" />
            ...
            <div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10 order-2 order-lg-1">
                <div class="d-flex flex-center flex-column flex-lg-row-fluid">
                    <div class="w-lg-500px p-10">
                        <form class="form w-100" novalidate="novalidate" action="#" method="POST" id="form_forgot_password">
                            @csrf
                            <div class="text-center d-none" id="show_loading">
                                ...
                                <span class="d-block">Sedang mengirim pesan ke email</span>
                            </div>
                            <div class="text-center mb-11">
                                ...
                                <h1 class="text-dark fw-bolder mb-3 mt-7">Forgot Password</h1>
                                <div class="text-gray-500 fw-semibold fs-6">Enter your email to reset your password</div>
                            </div>
                            <div class="separator separator-content my-14">
                                <span class="w-150px text-gray-500 fw-semibold fs-7">Email</span>
                            </div>
