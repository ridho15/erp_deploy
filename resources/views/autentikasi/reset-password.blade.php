...
<head>
    <title>Reset Password | {{ $web_config['web_name'] }}</title>
    <meta charset="utf-8" />
            ...
            <div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10 order-2 order-lg-1">
                <div class="d-flex flex-center flex-column flex-lg-row-fluid">
                    <div class="w-lg-500px p-10">
                        <form class="form w-100" novalidate="novalidate" action="{{ route('post.reset-ulang-password') }}" method="POST">
                            @csrf
                            <div class="text-center mb-11">
                                ...
                                <h1 class="text-dark fw-bolder mb-3 mt-7">Reset Password</h1>
                                <div class="text-gray-500 fw-semibold fs-6">Enter your new password</div>
                            </div>
                            <div class="separator separator-content my-14">
                                <span class="w-150px text-gray-500 fw-semibold fs-7">Password</span>
                            </div>
                            ...
                            <div class="fv-row mb-8">
                                <input type="password" placeholder="Konfirmasi Password" name="password_konfirmasi" autocomplete="off"
                                    class="form-control bg-transparent" required/>
                            </div>
                            ...
                            <input type="hidden" name="token" class="form-control form-control-solid" value="{{ $token }}">
