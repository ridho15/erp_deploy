...
<body>
    <div
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%"
            style="border-collapse:collapse;margin:0 auto; padding:0; max-width:700px">
            <tbody>
                <tr>
                    <td align="center" valign="center" style="text-align:center; padding: 40px">
                        <a href="{{ url('') }}" rel="noopener" target="_blank">
                            <img alt="Logo" src="{{ asset($web_config['web_logo']) }}"
                                onerror="this.src='{{ asset('/assets/images/icon.png') }}'" class="h-50px h-lg-55px" />
                        </a>
                    </td>
                </tr>
                <tr>
                    <td align="left" valign="center">
                        <div
                            ...
                            <div>
                                ...
                                <table>
                                    ...
                                    <tbody style="border: 1px solid black">
                                        ...
                                        <tr>
                                            <td colspan="6"
                                                style="font-style: italic; text-align: center; font-weight: bold">Sub
                                                Total</td>
                                        ...
                                        <tr>
                                            <td colspan="6"
                                                style="font-style: italic; text-align: center; font-weight: bold">PPN
                                                10%</td>
                                            <td style="font-weight: bold; text-align: end">
                                                {{ 'Rp.' . number_format((10 / 100) * $subTotal, 0, ',', '.') }}</td>
                                        </tr>
                                        <tr>
                                            <td colspan="6"
                                                style="font-style: italic; text-align: center; font-weight: bold">Total
                                                Harga</td>
                                            <td style="font-weight: bold; text-align: end">
                            ...
                            <div style="display: flex; justify-content: space-evenly">
                                <a href="{{ url('/management-tugas/export/' . $quotation->id_laporan_pekerjaan) }}"
                                    style="padding: 10px; border: 1px solid black; border-radius: 10px; display: flex; align-items: center; text-decoration: none">
                                    <img src="{{ asset('/assets/images/icon_pdf.svg') }}" alt=""
                                        style="height: 25px; width: 25px; object-fit: contain; margin-right: 10px">
                                    <span>Quotation</span>
                                </a>
                                @if ($quotation->file)
                                    <a href="{{ config('app.asset_url') . '/storage' . $quotation->file }}"
                                        style="padding: 10px; border: 1px solid black; border-radius: 10px; display: flex; align-items: center; text-decoration: none">
                                        <img src="{{ asset('/assets/images/icon_file.svg') }}" alt=""
                                            style="height: 25px; width: 25px; object-fit: contain; margin-right: 10px">
                                        <span>File</span>
                                    </a>
                                @endif
                            ...
                            <div style="text-align: center; margin-top: 20px">
                                <a href="{{ route('quotation.konfirmasi', ['id' => $quotation->id]) }}"
                ...
                <tr>
                    <td align="center" valign="center"
                        ...
                        <p>Copyright ©
                            <a href="{{ url('') }}" rel="noopener" target="_blank">Dokgo</a>.
                        </p>
                    </td>
                </tr></br>
    </div>
