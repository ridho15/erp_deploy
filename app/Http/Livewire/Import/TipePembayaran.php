...
use App\Imports\ImportTipePembayaran;
...
class TipePembayaran extends Component
{
    ...
    {
        return view('livewire.import.tipe-pembayaran');
    }
    ...
    public function simpanData()
    {
        ...
        try {
            activity()->causedBy(HelperController::user())->log("Melakukan import data tipe pembayaran");
            // (new ImportSales)->import($this->file, 'local', ExcelSecond::XLSX);
            $import = new ImportTipePembayaran;
            $import->import($this->file);
            $message = "Berhasil melakukan import data tipe pembayaran";
            $this->file = null;
