...
use App\Imports\ImportMetodePembayaran;
...
class MetodePembayaran extends Component
{
    ...
    {
        return view('livewire.import.metode-pembayaran');
    }
    ...
    public function simpanData()
    {
        ...
        try {
            activity()->causedBy(HelperController::user())->log("Melakukan import data metode pembayaran");
            // (new ImportSales)->import($this->file, 'local', ExcelSecond::XLSX);
            $import = new ImportMetodePembayaran;
            $import->import($this->file);
            $message = "Berhasil melakukan import data metode pembayaran";
            $this->file = null;
